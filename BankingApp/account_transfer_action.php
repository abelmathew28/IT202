...
if($_POST) {
	...
	if(!empty($holders_detail_data) ){
	 	...
	 	$account_activity = "INSERT INTO account_activity (transaction_type, amount,effective_balance, depositer_detail_id,recipient_detail_id,activity_date,status) VALUES ('transfer', '$amount','$balance','$detailsid','$recipient_detail_id', '$date', '$status')"; 
