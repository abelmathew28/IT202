...
.registerdetails{
  ...
  margin:20px;
    ...
    var balance = Number(currentbalance) + Number(amount);     
    if(balance>=currentbalance ) {
            
           alert("Your Balace Is:"+balance);
  ...
  <body>
    ...
    <div class="registersec">
      <div class="registerdetails">
             <div class="register">
  <h4>Deposit Form </h4>
 <form action="account_deposit_action.php"  name = "myForm" onsubmit = "return(validate());" method="post">
